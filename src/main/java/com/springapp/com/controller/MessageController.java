...
public class MessageController {
    ...
    //Create a method PutMapping to use PUT Request Method and pass first name as Path Variable and last name as Query Parameter
    //curl -X PUT localhost:8080/hello/put/Sunil/?lastName=Meena -w "\n"
